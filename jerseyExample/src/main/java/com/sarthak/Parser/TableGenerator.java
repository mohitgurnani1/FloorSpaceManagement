...
public class TableGenerator {
    ...
    private TableData generateTable(Desk desk,String layoutId){
        ...
        //System.out.println("For table number "+tableNumber+" Max x "+maxPushPointX+" Max Y "+maxPushPointY);
        ...
        return new TableData(tableNumber,desksForCurrentTable,finalTable1,maxPushPointY+1,maxPushPointX+1,topLeftX,topLeftY,layoutId);
    }
